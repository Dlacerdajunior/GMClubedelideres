           ...
           <div id="tudocamp"> 
              <div id="campanhaDesc">
                <table align="center" width="1000" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF"> 
                    <tr>
                      <td><img src="<?php echo $this->base;?>/Africa_pos/images/hotsite_Africa_pos_01_Acessorios.jpg"></td>
                    </tr>
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>
                                ...
                                ?>    
                                <a href="<?php echo $this->base;?>/campanhas/africaacessorios/" class="bthome"></a>
                                <?php
                                }
                                ?> 
                              ...
                              <td>
                                ...
                                ?>    
                                <a href="<?php echo $this->base;?>/campanhas/africaacessorios/regulamento" class="btregulamento"></a>
                                <?php
                                } 
                                ?>
                              </td>
                              ...
                              <td>                             
                               ...
                               <img src="<?php echo $this->base;?>/Africa_pos/images/ranking-over.png">
                                ...
                                ?>    
                               <a href="<?php echo $this->base;?>/campanhas/africaacessorios/ranking" class="btranking"></a>
                                <?php
                                }
                                ?> 
                              ...
                              <td>
                                ...
                                ?>    
                                <a href="<?php echo $this->base;?>/campanhas/africaacessorios/premiacao" class="btpremiacao"></a>
                                <?php
                                }
                                ?> 
                              </td>
