                ...
                <table id="Table_01" align="center" width="1000" height="714" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          ?>
                          <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronagenebra/" class="bthome"></a>                      
                          <?php
                          }
                          ?> 
                        ...
                        <td colspan="2">                      
                          ...
                          ?>    
                          <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronagenebra/regulamento" class="btregulamento"></a>
                          <?php
                          }
                          ?> 
                        ...
                        <td>
                            ...
                            ?>    
                           <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronagenebra/premiacao" class="btpremiacao"></a>
                            <?php
                            }
                            ?> 
                    ...
                    <tr>
                        <td colspan="3">
                          ...
                          <img src="<?php echo $this->base;?>/sucessopedecaronagenebra/images/index_08.png" width="444" height="208" alt="">
                          ...
                          <img src="<?php echo $this->base;?>/sucessopedecaronagenebra/images/left_ranking_08.png" width="444" height="208" alt=""> 

                          <?php
                          }else if($tipo == "premiacao"){
                          ?>

                          <img src="<?php echo $this->base;?>/sucessopedecaronagenebra/images/left_premiacao_08.png" width="444" height="208" alt=""> 

                          <?php 
                          }else{
                          ?>  
                            <img src="<?php echo $this->base;?>/sucessopedecaronagenebra/images/left_regulamento_08.png" width="444" height="208" alt="">                   
                          <?php
                          }
                          ?> 
