                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                   <td width="97">
                    ...
                    ?>    
                    <a href="<?php echo $this->base;?>/campanhas/descobertapremiada2/" class="bthome"></a>
                    <?php
                    }
                    ?>
                    </td>
                   <td width="126">
                    ...
                    ?>    
                    <a href="<?php echo $this->base;?>/campanhas/descobertapremiada2/regulamento" class="btregulamento"></a>
                    <?php
                    }
                    ?>
                    </td>
                   ...
                   <img src="<?php echo $this->base;?>/descoberta-premiada/images/ranking-over.jpg">
                    ...
                    ?>    
                   <a href="<?php echo $this->base;?>/campanhas/descobertapremiada2/ranking" class="btranking"></a>
                    <?php
                    }
                    ?>
                    </td>
                   <td>
                    ...
                    ?>    
                   <a href="<?php echo $this->base;?>/campanhas/descobertapremiada2/premiacao" class="btpremiacao"></a>
                    <?php
                    }
                    ?>
                    </td>
