            ...
            <div id="tudocamp">
              <div id="campanhaDesc">
                <table id="Table_01" align="center" width="1000" height="714" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="8">
                            <img src="<?php echo $this->base;?>/carona/images/index_01.jpg" width="1000" height="430" alt=""></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $this->base;?>/campanhas/sucessopedecarona/" class="bthome"></a></td>
                        <td colspan="2">
                            <a href="<?php echo $this->base;?>/campanhas/sucessopedecarona/regulamento" class="btregulamento"></a></td>
  ...
  <tr>
    ...
    <td>
                          ...
                          ?>
                          <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronapremiacao/regulamento" class="btdestino"></a>   
  ...
  <tr>
    <td>
                            ...
                            ?>    
                           <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronapremiacao/premiacao" class="btdicas"></a>
                            <?php
                            }
                            ?> 
  ...
  <tr>
    <td>
                           ...
                           <img src="<?php echo $this->base;?>/carona/images/hoteis-over.png" width="101" height="29" alt="">
                            ...
                            ?>    
                              <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronapremiacao/ranking" class="bthoteis"></a>
                            <?php
                            }
                            ?> 
  ...
  <tr>
    <td>
                          ...
                          ?>  
                            ...
                            <a href="<?php echo $this->base;?>/campanhas/sucessopedecaronapremiacao/descricao" class="btroteiro"></a>                
