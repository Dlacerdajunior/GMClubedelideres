        ...
        $('#fileupload').fileupload({
           ...
           singleFileUploads: false
            ...
            $.each(data.result, function (index, file){
                ...
                $.ajax({
                  url: '<?php echo $this->base;?>/admin/ranking/importestudovagasxls/<?php echo $id_ranking; ?>/'+file.name,
    ...
    <tr>
        <td class="col01">
                    ...
                    <div style="font-weight: bold;margin-left: 62px;">
                        ...
                        <p>*As colunas no XLS deve ser : |Cód| Concessionária | Vagas - Opcão 2 | </p>
