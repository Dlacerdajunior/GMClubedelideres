<script type="text/javascript">
    $(function(){
        ...
        oTable = $('#grid-registros').dataTable({
            ...
            "bAutoWidth": false,
            "bProcessing": true,
            "sAjaxSource": "<?php echo $this->base;?>/admin/usuarios/jsondatacontenplados",
    ...
    <div class="one_wrap fl_left">
        <div class="widget">
                ...
                <div class="widget_title"><span class="iconsweet">}</span><h5>Desempenho de Líderes</h5></div>

                <div class="widget_body">

                <table class="activity_datatable" id="grid-registros" >
                    <thead> 
                        <tr>
