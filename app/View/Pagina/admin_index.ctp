<script type="text/javascript">
    $(function(){
        ...
        oTable = $('#grid-registros').dataTable({
            ...
            "bAutoWidth": false,
            "bProcessing": true,
            "sAjaxSource": "<?php echo $this->base;?>/admin/pagina/jsondata/",
    ...
    <div class="one_wrap fl_left">
        <div class="widget">
                ...
                <div class="widget_title"><span class="iconsweet">}</span><h5>Página</h5></div>
                ...
                <table class="activity_datatable" id="grid-registros" width="100%" border="0" cellspacing="0" cellpadding="8">
                    <thead>
                        <tr> 
                            ...
                            <th style="width: 150px;">Permalink</th>
